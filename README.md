...
This is an interactive Streamlit application for simulating the FIFA World Cup 2026 tournament using data-driven prediction and scenario-planning logic.

The project allows users to update group-stage results, recalculate group tables, generate Round of 32 qualifiers, simulate knockout rounds, manually change knockout winners, and observe how the predicted champion changes.
